...
class SampleModel:
    ...
    def start(self) -> None:
        ...
        self.tts.speech("うん、")  # エリカに発話させる
        self.tts.speech("そうだね。")  # エリカに発話させる
        self.pause(2)
        self.tts.speech("まずは会場から決めようか。")  # エリカに発話させる
        self.pause(2)
        self.tts.speech("学内でやるか、")
        self.tts.speech("それとも学外のレストランとかにする？")
